...
def get_dab_settings(
    ...
    """
    # Controller integration CI fails on warnings, so not warning here
    # warnings.warn(
    #     "The function `get_dab_settings` is deprecated and will be removed in a future version. "
    #     "Please use `ansible_base.lib.dynamic_config.factory` instead.",
    #     DeprecationWarning,
    #     stacklevel=2,
    # )
...
def get_mergeable_dab_settings(settings: dict) -> dict:  # NOSONAR
    """This function takes a settings dict and returns a dict of DAB settings to be merged into the Dynaconf settings.
